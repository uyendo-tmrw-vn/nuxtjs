<template>
  <div class="px-4 mt-[20vh] py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    ...
    <Head>
      ...
      <Meta
        name="og:title"
        :content="`${postDetail.id}`+'.'+`${postDetail.username}`"
      />
    </Head>
      ...
      <table class="min-w-full table-auto ">
        ...
        <tbody class="bg-gray-200">
          ...
          >
            ...
            <td>
              <span class="text-left block ml-2 font-semibold">{{ postDetail.username}}</span>
            </td>
            <td>
              <span class="text-left block ml-2 font-semibold">{{ postDetail.email }}</span>
            </td>
          </tr>
          <tr
            class="bg-white border-4 border-gray-200"

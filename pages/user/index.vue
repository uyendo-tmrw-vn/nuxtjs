  ...
  <div>
    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div class="max-w-screen-sm sm:text-center sm:mx-auto">
        <h2 class="mb-4 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">User</h2>
        ...
        <table class="min-w-full table-auto ">
          ...
          <tbody class="bg-gray-200">
            ...
            >
              ...
              <td>
                <span class="text-left block ml-2 font-semibold">{{ post.email }}</span>
              </td>
              <td class="py-2 px-4 text-center">
                <NuxtLink
                  :to="`/user/${post.id}`"
                  class="text-center block ml-2 hover:underline bg-[green] px-2 py-1 text-[#fff]"
                >View</NuxtLink>
              </td>
            </tr>
          </tbody>
